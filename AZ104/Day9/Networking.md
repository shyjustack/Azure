...
![Azure Virtual Network Manager - Hub and Spoke Topology]([https://github.com/shyjustack/Azure/blob/main/media/azure-virtual-network-manager-network-topologies.png]
