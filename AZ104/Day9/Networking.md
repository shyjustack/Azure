...
![Azure Virtual Network Manager - Hub and Spoke Topology]([media/azure-virtual-network-manager-network-topologies.png](https://github.com/shyjustack/Azure/blob/main/media/azure-virtual-network-manager-network-topologies.png))
